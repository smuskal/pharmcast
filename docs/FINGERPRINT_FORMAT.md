...
A fingerprint is **330 unsigned 32-bit words** — 10,560 slots, of which the
...
- **7 feature types** — acceptor, donor, negative, positive, hydrophobic,
  aromatic, other.
- **6 distance bins** — 2.0–4.5, 4.5–7.0, 7.0–10.0, 10.0–14.0, 14.0–19.0,
  19.0–24.0 Å.
...
## The bit convention — do not "fix" one side
